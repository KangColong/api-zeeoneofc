...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'SKYBOTZ') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'SKYBOTZ') return res.json(loghandler.invalidKey)
...
router.get('/muslim/niatshalat', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'SKY BOTZ') return res.json(loghandler.invalidKey)
